...
if %ERRORLEVEL% neq 0 (
    ...
    .venv\Scripts\uv.exe pip install torch>=2.6.0 --python .venv\Scripts\python.exe --index-url https://download.pytorch.org/whl/cu118
    if %ERRORLEVEL% neq 0 (
...
echo =================================================
echo Next Steps:
echo   1. Test semantic search: start_mcp_server.cmd
