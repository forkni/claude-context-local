...
try:
    ...
    logger.error("Please ensure you have an active internet connection and sufficient disk space.")
    logger.error("If the model requires Hugging Face authentication, ensure you are logged in via 'huggingface-cli login'.")
    exit(1)
