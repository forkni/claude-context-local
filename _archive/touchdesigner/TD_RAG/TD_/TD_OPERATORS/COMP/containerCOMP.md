...
```python
# Access the COMP containerCOMP operator
containercomp_op = op('containercomp1')

# Get/set parameters
freq_value = containercomp_op.par.active.eval()
containercomp_op.par.active = 1
```
...
containercomp_op.inputConnectors[0].connect(input_op)
output_op.inputConnectors[0].connect(containercomp_op)
```
