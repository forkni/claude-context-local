...
```python
# Access the TOP subtractTOP operator
subtracttop_op = op('subtracttop1')

# Get/set parameters
freq_value = subtracttop_op.par.active.eval()
subtracttop_op.par.active = 1
```
...
subtracttop_op.inputConnectors[0].connect(input_op)
output_op.inputConnectors[0].connect(subtracttop_op)
```
