...
```python
# Access the TOP inTOP operator
intop_op = op('intop1')

# Get/set parameters
freq_value = intop_op.par.active.eval()
intop_op.par.active = 1
```
...
intop_op.inputConnectors[0].connect(input_op)
output_op.inputConnectors[0].connect(intop_op)
```
