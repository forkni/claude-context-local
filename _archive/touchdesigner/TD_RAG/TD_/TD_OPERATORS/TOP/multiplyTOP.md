...
```python
# Access the TOP multiplyTOP operator
multiplytop_op = op('multiplytop1')

# Get/set parameters
freq_value = multiplytop_op.par.active.eval()
multiplytop_op.par.active = 1
```
...
multiplytop_op.inputConnectors[0].connect(input_op)
output_op.inputConnectors[0].connect(multiplytop_op)
```
