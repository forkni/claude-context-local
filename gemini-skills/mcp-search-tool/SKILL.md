...
**For full API reference**: See `references/MCP_TOOLS_REFERENCE.md`
...
**For complete parameter lists, examples, and detailed usage**: See `references/MCP_TOOLS_REFERENCE.md`
...
- `references/MCP_TOOLS_REFERENCE.md` — Complete 19-tool API reference
- `references/ADVANCED_FEATURES_GUIDE.md` — Multi-hop, routing, models, graph search
- `references/HYBRID_SEARCH_CONFIGURATION_GUIDE.md` — Search modes, weights, optimization