...
# REMOVED (2026-08-01): test_concurrent_search_weight_isolation
# Reason: intent-adaptive fusion weights were measured and rejected (ADR-0019) — the
# orchestrator no longer forwards per-request bm25/dense weight kwargs at all, so the
# shared-state race this test guarded against is structurally impossible.
