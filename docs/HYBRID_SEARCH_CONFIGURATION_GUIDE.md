...
- **Proven quality metrics**: MRR 0.8419 on the 63-query canonical golden set, k=10, hybrid mode (2026-09-01 P0 re-baseline, shipped default; see [SSCG Retrieval Benchmark](BENCHMARKS.md#sscg-retrieval-benchmark) for the full provenance-stamped tables and comparability notes)
