...
- **Proven quality metrics**: MRR 0.8339 on the 63-query canonical golden set, k=10, hybrid mode (`canon_d1`, 2026-08-04 baseline; see [SSCG Retrieval Benchmark](BENCHMARKS.md#sscg-retrieval-benchmark) for the full provenance-stamped tables and comparability notes)
