...
- **SSCG Benchmark**: MRR 0.8339 (canonical, 63q, k=10, `canon_d1`) / 0.6591 (expanded, 133 non-D, k=10, `canon_d2`) — see `evaluation/CANON_20260804.md` for full provenance and the code-drift/dataset-change delta split; the README's k=7 headline (MRR 0.787-0.796, 2026-07-27) is a separate operating point, not directly comparable
