...
### Results (2026-09-23, hybrid-only, k=10, deterministic, `fill_budget` A/B adoption re-pin — current canon-of-record)
...
### Results (2026-09-20, hybrid-only, k=10, deterministic, resolver-mix restoration re-pin — superseded by the 09-23 pin above)
