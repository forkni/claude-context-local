...
### Results (2026-09-01, hybrid-only, k=10, deterministic, P0 re-baseline)
...
Deltas vs the prior 2026-08-22 pin (0.8462/0.6482/0.9034) are −0.0043 / −0.0104 / −0.0191 — a **comparability break** recorded as substrate drift (+2 files / +31 chunks / +184 edges after the ADR-0039→0059 architecture wave), not investigated, per the project's drift convention. The expanded-set hard-miss cohort (recall@10 = 0) is substrate-dependent and was re-derived this generation in `evaluation/CANON_20260901_REBASELINE.md` (9/133, superseding the 2026-08-22 list of 12) — re-derive the miss list from the current baseline before targeting it.
