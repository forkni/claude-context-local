...
The remaining 18 `scripts/benchmark/*.py` files (of 36 total) still hand-roll their own bootstrap —
...
- 18 of 36 `scripts/benchmark/*.py` files remain unmigrated; each future migration is expected to
